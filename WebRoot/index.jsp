...
<ul>                               
                  <a href="order/order_addOrder?honey.honeyid=<s:property ><value='honeyid'/>&customer.name=<s:property value='#session.customer.name'/>" class="add">
	              <h4>
	              <li>  <a href="detail.jsp"><img src="images/123.jpg"align="bottom"><center>荆条蜜  销售价：￥78</center> </a></li>
                  ...
                  <li> <a href="detail.jsp"><img src="images/pic05.jpg"align="bottom"><center>金桔蜜  销售价：￥158</center></a> </li>
                  </h4>
	      </ul>
	</main>
  </body>
