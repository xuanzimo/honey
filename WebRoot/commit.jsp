...
function html_decode(str) {
  ...
  <div class="nav" id="nav">
    ...
    <div class="wrap"> <a class="logo" href="/"><img src="images/logo.jpg" width="215" height="50"/></a> 
     ...
     <s:form action="commit/commit_addCommit" method="post">
                     <input type="hidden" name="customer.name" value="<s:property value='#session.customer.name'/>"/>
                      <input type="hidden" name="honey.honeyid" value="<s:property value='honey.honeyid'/>"/>
                       <div class="form-group"> 
			                <label class="control-label col-md-3">蜂蜜简介</label>
			                <div class="col-md-6">
			                 <textarea id="summernote" name="massage"  required></textarea> 
			               </div>
			            </div>
