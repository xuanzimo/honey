...
<div style="width: 400px;height: 200px;margin: auto auto;background: #ffffff;text-align: center;margin-top: -100px;border: 1px solid #e7e7e7">
   ...
   <s:form action="customer/customer_login" method="post">
    <p style="padding: 30px 0px 10px 0px;position: relative;">
        ...
        <input class="ipt" type="text" placeholder="username" name="customer.name">
    
    </p>
    <s:fielderror fieldName="customer.name" cssClass="fielderror"></s:fielderror>
    <p style="position: relative;">
        <span class="p_logo"></span>
        <input id="password" class="ipt" type="password"  placeholder="Password" name="customer.password">
    </p>
    ...
    <div style="height: 50px;line-height: 50px;margin-top: 30px;border-top: 1px solid #e7e7e7;">
        <p style="margin: 0px 35px 20px 45px;">
           ...
           <span style="float: right">
               <a href="reg.jsp" style="background: #008ead;padding: 7px 10px;border-radius: 4px;border: 1px solid #1a7598;color: #FFF;font-weight: bold;">Sign Up</a>
               <button class="hi" type="submit" style="background: #008ead;padding: 7px 10px;border-radius: 4px;border: 1px solid #1a7598;color: #FFF;font-weight: bold;">Login</button>
           </span>
        </p>
    </div>
      </s:form>
