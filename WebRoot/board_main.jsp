    ...
    <main class="container-fluid">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
		    ...
		    <s:form action="board/board_queryBoard" method="post">
		    </s:form>
	                              ...
	                              <s:iterator value="boardList" status="status">
	                                  ...
	                                  <tr>
	                                     <s:if test="niming==0">
	                                      ...
	                                      <td class="center"><s:property value="message" escape="false"></s:property></td>
	                                      <td class="center"><s:property value="email" ></s:property></td>
	                                  </tr>
